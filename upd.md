...
5.  Теперь бот нормально реагирует на текст содержащий более 4028 символов в команде **`f!lyrics`**\


    <figure><img src=".gitbook/assets/image (3).png" alt=""><figcaption><p>*трек взят в качестве примера.</p></figcaption></figure>
6. Откатились до более старой версии пакета discord.js, теперь кнопки и менюшки снова работают, а бот — не падает :)
7. Топы по монетам и биткоинам пофикшены.
8. Теперь шар (**`f!8ball`**) не отвечает на сообщения без вопроса.
