...
{% hint style="danger" %}
Репутация была удалена из бота, этот вопрос стал недействительным.
{% endhint %}
...
Узнать префикс бота можно упомянув его, так Вы сразу получите префикс сервера
...
Нет, БД одинакова для всех серверов, и это даже удобно. Думаю, мы не будем делать для каждого сервера отдельные базы.
